...
//		}
	...
	$(".demon_Btn").click(function() {
		...
		/*if(!exist) {
			if($(this).children(".text").children(".arrowRight").hasClass("arrowRight_cur")) {
				$(this).children(".text").children(".arrowRight").removeClass("arrowRight_cur");
			} else {
				$(this).children(".text").children(".arrowRight").addClass("arrowRight_cur");
			}
